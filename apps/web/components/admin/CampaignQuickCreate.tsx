        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40" onClick={() => setOpen(false)}>
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 text-base">צור תמונת קמפיין</h3>
                <p className="text-xs text-gray-500">בחר לקוח כדי להתחיל</p>
              </div>
            </div>

            <div className="space-y-4">
              <div>
                <label className="text-sm font-medium text-gray-700 block mb-1.5">לקוח</label>
                <select
                  value={selected}
                  onChange={(e) => setSelected(e.target.value)}
                  className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm bg-white focus:ring-2 focus:ring-indigo-300 outline-none"
                >
