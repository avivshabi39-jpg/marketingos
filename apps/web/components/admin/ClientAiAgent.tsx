...
const QUICK_ACTIONS = [
  { label: "📊 מה הביצועים?",   message: "תראה לי סטטיסטיקות מלאות של הלקוח" },
  { label: "📋 צור דוח עכשיו",  message: "צור לי דוח ביצועים שבועי" },
  { label: "🌐 פרסם את הדף",   message: "פרסם את דף הנחיתה עכשיו" },
  { label: "✍️ שנה כותרת",      message: "שנה את הכותרת הראשית של הדף" },
  { label: "🎯 הוסף ליד",      message: "הוסף ליד חדש למערכת" },
  { label: "💬 הודעת וואצאפ",  message: "כתוב הודעת ברכה לוואצאפ ללידים חדשים" },
  { label: "📈 המלצות לשיפור",  message: "תן לי 3 המלצות ספציפיות לשיפור" },
  { label: "🔄 בנה דף מחדש",   message: "בנה לי דף נחיתה חדש מאפס" },
];
