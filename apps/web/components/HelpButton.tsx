  ...
  return (
    <>
      <button
        ...
        className="w-7 h-7 rounded-full bg-gray-100 border border-gray-200 hover:bg-gray-200 transition-colors flex items-center justify-center text-sm font-bold text-gray-500 hover:text-gray-700 flex-shrink-0"
        title="עזרה"
        aria-label="עזרה"
      >
        ?
      ...
      {open && (
        ...
        >
          ...
          >
            ...
            <button
              onClick={() => setOpen(false)}
              className="mt-6 w-full bg-indigo-600 hover:bg-indigo-700 text-white font-semibold text-sm py-2.5 rounded-xl transition-colors"
            >
              הבנתי! ✅
            </button>
          </div>
