...
const SUGGESTED_ACTIONS = [
  ...
  {
    category: "📞 מכירות ואסטרטגיה",
    items: [
      { label: "סקריפט מכירה", msg: "כתוב סקריפט מכירה טלפוני מקצועי" },
      { label: "ניתוח SWOT", msg: "עשה ניתוח SWOT מקצועי לעסק" },
      { label: "טיפול בהתנגדויות", msg: "תן לי תסריט לטיפול בהתנגדויות מכירה" },
      { label: "אסטרטגיית תמחור", msg: "המלץ על אסטרטגיית תמחור פסיכולוגית" },
    ],
  },
  {
