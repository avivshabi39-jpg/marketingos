    ...
    <div className="space-y-6" dir="rtl">
      <div>
        <h1 className="text-2xl font-bold text-slate-900 flex items-center gap-2">
          <BarChart2 size={22} className="text-blue-500" /> אנליטיקס
        </h1>
        <p className="text-sm text-slate-500 mt-1">30 הימים האחרונים</p>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        {[
          ...
          { label: "צפיות (סה\"כ)", value: totalViews, icon: TrendingUp, color: "bg-blue-50 text-blue-600" },
        ...
        <div className="bg-white rounded-xl border border-slate-100 shadow-sm p-5">
          ...
          <div className="mb-4">
            <div className="flex justify-between text-sm mb-1">
              <span className="text-slate-600">ציון כולל</span>
